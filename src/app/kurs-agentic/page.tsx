...
export const metadata: Metadata = {
  title: 'Die Agentic Company – KI-Agenten Kurs auf Deutsch | SPEKTRUM',
  description: 'Der erste deutschsprachige Kurs zu KI-Agenten und autonomen Workflows. Agentic AI, Multi-Agenten-Systeme und KI-Automatisierung für den DACH-Raum. 90 Tage Zugang – CHF 39.',
  keywords: ['KI Agenten Kurs Deutsch', 'Agentic AI Kurs', 'autonome KI Workflows DACH', 'Multi-Agenten Systeme', 'KI Automatisierung Kurs Deutschland', 'KI Agent Weiterbildung', 'Agentic Company Kurs'],
  alternates: { canonical: 'https://kurse.spekt.ch/kurs-agentic' },
  openGraph: {
    title: 'Die Agentic Company – KI-Agenten Kurs auf Deutsch',
    description: 'KI-Agenten und autonome Workflows – der erste deutschsprachige Kurs zum Thema Agentic AI.',
    url: 'https://kurse.spekt.ch/kurs-agentic',
...
export default async function KursAgenticPage() {
  ...
  const allLessonIds = COURSE_AGENTIC.modules.flatMap(m => m.lessons.map(l => `${m.slug}/${l.slug}`));
  ...
  const purchased = hasCourseAccess(user, 'kurs-agentic');
  const expiry = getCourseExpiry(user, 'kurs-agentic');
    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .kp-badge {
          ...
          font-weight: 600; border: 1.5px solid #5e35b1;
          color: #4527a0; background: #f3f0ff; white-space: nowrap;
        }
        ...
        .kp-progress-label {
          font-size: 12px; font-weight: 700; color: #5e35b1;
        ...
        .kp-section-heading svg { color: #5e35b1; flex-shrink: 0; }
        .kp-module-card {
          background: white; border: 1.5px solid #e8e8ed;
          border-radius: 14px; padding: 24px; margin-bottom: 16px;
          transition: border-color 0.15s, box-shadow 0.15s;
        }
        .kp-module-card:hover { border-color: #c5b4e8; box-shadow: 0 4px 20px rgba(94,53,177,0.08); }
        ...
        .kp-quiz-pill {
          ...
          border: 1.5px solid #5e35b1; color: #4527a0;
        ...
        .kp-buy-btn {
          ...
          background: linear-gradient(135deg, #5e35b1 0%, #0057a8 100%);
        ...
        .kp-lesson:hover { border-color: #5e35b1; background: #f3f0ff; }
        .kp-lesson.done { border-color: #c5b4e8; background: #f3f0ff; }
        .kp-lesson-check {
        ...
        .kp-lesson-check.done { background: #5e35b1; border-color: #5e35b1; color: white; }
        ...
        .kp-final-card {
          background: white; border: 1.5px solid #c5b4e8;
          border-radius: 14px; padding: 24px; margin-bottom: 16px;
        }
        .kp-final-heading {
          display: flex; align-items: center; gap: 10px;
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@type': 'Course',
        name: 'Die Agentic Company',
        description: 'Der erste deutschsprachige Kurs zu KI-Agenten und autonomen Workflows. Agentic AI, Multi-Agenten-Systeme und KI-Automatisierung.',
        url: 'https://kurse.spekt.ch/kurs-agentic',
        ...
        coursePrerequisites: 'KI-Grundkenntnisse empfohlen',
        teaches: ['KI-Agenten', 'Autonome Workflows', 'Multi-Agenten-Systeme', 'Agentic AI Praxis'],
        hasCourseInstance: { '@type': 'CourseInstance', courseMode: 'online', courseWorkload: 'PT8H', inLanguage: 'de' },
      }) }} />
      ...
      <div className="kp-wrap">
        ...
        <div className="kp-header">
          <div className="kp-title-row">
            <h1 className="kp-title">{COURSE_AGENTIC.title}</h1>
            <span className="kp-badge">Experte</span>
          </div>
          <p className="kp-subtitle">{COURSE_AGENTIC.description}</p>
        </div>

        {/* Preis-Card */}
        {purchased ? (
          <div className="kp-price-card" style={{ background: 'linear-gradient(135deg, #f3f0ff 0%, #ede8ff 100%)', borderColor: '#c5b4e8' }}>
            <div className="kp-price-left">
              <div className="kp-price-amount" style={{ color: '#4527a0' }}>✓ Zugang aktiv</div>
          ...
          <div className="kp-price-card">
            ...
            <BuyButton courseSlug="kurs-agentic" label="Zugang kaufen – CHF 39" color="#5e35b1" />
          </div>
        )}
        ...
        {COURSE_AGENTIC.modules.map((modul, mi) => {
          ...
          return (
            <div key={modul.id} className="kp-module-card">
              ...
              <div className="kp-module-meta">
                ...
                {doneLessons > 0 && (
                  <span className="kp-meta-item" style={{ color: '#5e35b1', marginLeft: 'auto' }}>
              ...
              <div className="kp-lessons">
                {modul.lessons.map((lektion, li) => {
                  ...
                  return (
                    <Link
                      key={lektion.id}
                      href={`/kurs-agentic/${modul.slug}/${lektion.slug}`}
        ...
        <div className="kp-final-card">
          ...
          <Link href="/zertifikat?course=kurs-agentic" className="kp-cert-badge" style={{ textDecoration: 'none', cursor: 'pointer' }}>
        ...
        <div className="kp-cta-bar">
          <span className="kp-cta-text">
            90 Tage Zugang zu allen {COURSE_AGENTIC.modules.length} Modulen inkl. Abschlusszertifikat.
          </span>
          {!purchased && <BuyButton courseSlug="kurs-agentic" label="Zugang kaufen – CHF 39" color="#5e35b1" />}
        </div>
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: '0 24px 48px', color: '#6e6e73', fontSize: 14, lineHeight: 1.7 }}>
        <h2 style={{ fontSize: 16, fontWeight: 700, color: '#1d1d1f', marginBottom: 10 }}>KI-Agenten und Agentic AI – der erste deutschsprachige Kurs</h2>
        <p>KI-Agenten sind der nächste grosse Schritt nach ChatGPT: Autonome Systeme, die selbständig Aufgaben übernehmen, Entscheidungen treffen und mit anderen Agenten zusammenarbeiten. Dieser Kurs ist der erste umfassende deutschsprachige Kurs zu Agentic AI im DACH-Raum. Du lernst, wie KI-Agenten funktionieren, wie du Multi-Agenten-Workflows aufbaust und wie diese Technologie die Arbeitswelt in Planung, Verwaltung und Wirtschaft verändert. Für alle, die KI auf die nächste Stufe bringen wollen.</p>
      </div>
