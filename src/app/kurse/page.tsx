      ...
      <section className="kl-faq-bg">
        ...
        <div className="kl-faq">
          {[
            ...
            { q: 'Was kostet ein KI-Kurs bei SPEKTRUM?', a: '«Interessenabwägung mit KI» ist gratis. Der Einstiegskurs «KI-Grundkurs Einsteiger» kostet CHF 89. KI-Intensivprogramme (3 Kurse, strukturierter Lernpfad) ab CHF 290 (Basis), CHF 590 (Plus mit 1:1-Sessions), CHF 1\'900 (Business, auf Anfrage). Einmalzahlung, kein Abo.' },
